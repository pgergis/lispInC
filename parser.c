...
lval *builtin_op(lval *a, char *op) {
    ...
    while (a->count > 0) {
        ...
        if (strcmp(op, "^") == 0 || strcmp(op, "exp") == 0) { powl(x->num, y->num); }
...
lval *builtin(lval *a, char *func) {
    ...
    if (strcmp("add", func) == 0) { return builtin_op(a, func); }
    if (strcmp("sub", func) == 0) { return builtin_op(a, func); }
    if (strcmp("div", func) == 0) { return builtin_op(a, func); }
    if (strcmp("mul", func) == 0) { return builtin_op(a, func); }
    if (strcmp("mod", func) == 0) { return builtin_op(a, func); }
...
int main (int argc, char *argv[]) {
    ...
    while (1) {
        ...
        if (mpc_parse("<stdin>", input, Lispy, &r)) {
            ...
            mpc_ast_print(r.output); // For debugging
